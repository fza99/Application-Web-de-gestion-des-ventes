<%-- 
    Document   : admin_cata
    Created on : 5 janv. 2019, 20:27:25
    Author     : start
--%>
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav flex-column">
                                    ...
                                    <li class="nav-item">
                                      ...
                                      <li class="nav-item">
                                        <i><a class="nav-link" href="Clients.jsp" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-f fa-folder"></i>Clients</a></li>
                                    </li>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                  <c:forEach var="row" items="${result.rows}" >
                                                    <tr>
                                                         <td>
                                                            <div class="m-r-10"><img src="<c:out value="${row.image}" />" alt="" class="rounded" width="120"></div>
                                                        </td>
                                                    ...
                                                    <form action="Produit" method="POST"> 
                                                        ...
                                                        <td><input value="<c:out value="${row.id}" />" name="id" /></td>
                                                ...
                                                <form action="Produit" method="POST">
                                                <div class="bouton">
                                                    <tr> <input class="btn btn-block btn-primary" name="ajouter" type="submit" value="Ajouter un produit"/></tr>
                                                        </div>
                                                    </div>
                                                 </form>
                                        </div>
