<%-- 
    Document   : Commandes
    Created on : 21 janv. 2019, 13:43:37
    Author     : start
--%>
        ...
        <div class="dashboard-main-wrapper">
            ...
            <div class="dashboard-main-wrapper">
                ...
                <div>
                    <div>
                    <div class="card">
                        <h5 class="card-header">Les Commandes</h5>
                                            ...
                                            <table class="table">
                                                <thead class="">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Date de Commade </th>
                                                        <th class="border-0">Id de Coammande</th>
                                                ...
                                                <s:query dataSource="${dbSource}" var="result"> select* from Commande </s:query>
                                                
                                                <tbody>
                                                  <c:forEach var="row" items="${result.rows}" >
                                                  <c:set var="IdCmd" value="${row.DateCmd}" scope="session" />
                                                    <tr>
                                                        <td><c:out value="${row.username}" /></td>
                                                        <td><c:out value="${row.DateCmd}"/></td>
                                                <form action="Affectation" method="POST">
                                                        <td><input value="<c:out value="${row.IdCmd}" />" name="IdCmd"/></td>
                                                        <td><c:out value="${row.Statut}" /></td>
                                                    <div class="bouton">
                                                        <td><i><a href="affectation.jsp" > <input class="btn btn-block btn-primary" name="Affecter" type="submit" value="Affecter"></a>
                                                             </div></td>
                                                    </div>
                                                </form>
                                                   </tr>
