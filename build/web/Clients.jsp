<%-- 
    Document   : Clients
    Created on : 21 janv. 2019, 15:33:15
    Author     : start
--%>
        ...
        <div class="dashboard-main-wrapper">
            ...
            <div class="dashboard-main-wrapper">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <i><a class="nav-link" href="affectation.jsp"  aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-f fa-folder"></i>Affecter</a></li>
                                    </li>
                ...
                <div>
                    <div>
                    <div class="card">
                        <h5 class="card-header">Votre Client</h5>
                              <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <s:query dataSource="${dbSource}" var="result"> select* from Client </s:query>
